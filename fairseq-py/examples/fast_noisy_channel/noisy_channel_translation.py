...
class NoisyChannelTranslation(TranslationMultiSimpleEpochTask):  #TranslationTask
    """
    ...
    def add_args(parser):
        ...
        TranslationMultiSimpleEpochTask.add_args(parser)   #TranslationTask
        # fmt: off
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            ...
            if self.args.channel_model is not None:
                ...
                ch_args_task.datadir = '/large_experiments/mmt/full_wmt/full_wmt.wmt_mined.joined.128k_rev/sharded_bin/shard000'
                channel_task = TranslationMultiSimpleEpochTask.setup_task(ch_args_task) #TranslationTask
