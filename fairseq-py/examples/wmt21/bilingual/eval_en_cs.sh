...
for CHECKPOINT_NAME in checkpoint_best; do
  for seed in 1 2 3 ; do
    MODEL_FOLDER=/checkpoint/chau/wmt21/bilingual/${tag}/dense.fp16.uf1.entsrc.SPL_temperature.tmp5.shem.ilr1e-07.wu4000.lr0.0002.clip0.0.drop0.2.wd0.0.seed${seed}.c10d.det.mt3000.transformer.ELS12.DLS12.encffnx4096.decffnx4096.E1024.H16.NBF.ATTDRP0.1.RELDRP0.0.ngpu8
