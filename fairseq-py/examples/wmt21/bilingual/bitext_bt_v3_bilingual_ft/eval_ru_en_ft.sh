for lang in ru; do
  for drop in 0.1 ; do
    CHECKPOINT_DIR=/checkpoint/chau/wmt21/bilingual_v3_blft.without2020.wmt/ru_en.ft.v3.32k/dense.mfp16.fp16.uf1.entsrc.SPL_temperature.tmp5.ilr1e-07.wu1.lr0.0001.clip0.0.drop0.1.wd0.0.seed1.no_c10d.det.mt2048.transformer.ELS12.DLS12.encffnx4096.decffnx4096.E1024.H16.NBF.ATTDRP0.1.RELDRP0.0.ngpu8
