...
# en-zh: checkpoint
# en-de: checkpoint
for CHECKPOINT_NAME in checkpoint40; do
  for seed in 1 2 3 ; do
    MODEL_FOLDER=/checkpoint/chau/wmt21/bilingual/en_ha.wmt_fb.joined.32k/dense.fp16.uf1.entsrc.SPL_temperature.tmp5.shem.ilr1e-07.wu4000.lr0.001.clip0.0.drop0.3.wd0.0.seed${seed}.c10d.det.mt3000.transformer.ELS4.DLS4.encffnx2048.decffnx2048.E512.H8.NBF.ATTDRP0.3.RELDRP0.3.ngpu32
