    ...
    for arch in "transformer_12_12"; do
      for lr in 0.0002; do
        python examples/wmt21/bilingual/sweep_1n.py \
            ...
            --finetune-from-model /checkpoint/chau/wmt21/bilingual/en_cs.wmt_mined.joined.32k/dense.fp16.uf4.entsrc.SPL_temperature.tmp5.shem.ilr1e-07.wu4000.lr0.001.clip0.0.drop0.2.wd0.0.seed${seed}.c10d.det.mt6000.transformer.ELS12.DLS12.encffnx4096.decffnx4096.E1024.H16.NBF.ATTDRP0.1.RELDRP0.0.ngpu32/checkpoint80.pt \
            --snapshot-code
      done
    done
  done
