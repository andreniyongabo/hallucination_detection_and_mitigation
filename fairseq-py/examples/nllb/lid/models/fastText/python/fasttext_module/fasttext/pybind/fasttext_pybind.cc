...
PYBIND11_MODULE(fasttext_pybind, m) {
  ...
  py::class_<fasttext::Meter>(m, "Meter")
      ...
      .def(
          "f1Score",
          (double (fasttext::Meter::*)() const) &
              fasttext::Meter::f1Score)
      .def(
          "f1ScoreLabel",
          (double (fasttext::Meter::*)(int32_t)) &
              fasttext::Meter::f1Score)
      .def(
          "precision",
          (double (fasttext::Meter::*)() const) &
  ...
  py::class_<fasttext::FastText>(m, "fasttext")
      ...
      .def(
          ...
          [](fasttext::FastText& m,
            ...
            fasttext::Meter meter(m.getDictionary()->nlabels(), false);
      ...
      .def(
          ...
          [](fasttext::FastText& m, const std::string& filename, int32_t k) {
            ...
            fasttext::Meter meter(m.getDictionary()->nlabels(), true);
      ...
      .def(
          ...
          [](fasttext::FastText& m,
            ...
            std::shared_ptr<const fasttext::Dictionary> d = m.getDictionary();
            fasttext::Meter meter(d->nlabels() ,false);
            m.test(ifs, k, threshold, meter);
