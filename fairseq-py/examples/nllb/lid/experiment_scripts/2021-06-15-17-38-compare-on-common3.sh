...
EXPERIMENT_NAME="2021-06-15-17-38-compare-on-common3"
...
# Languages both OurLID and CLD3 handle and exist in Flores99
ISO_639_3_LANGS_COMMON3=("nya" "afr" "amh" "ara" "hye" "aze" "ben" "bos" "bul" "mya" "cat" "ceb" "zho" "hrv" "ces" "dan" "nld" "eng" "est" "fin" "fra" "glg" "kat" "deu" "guj" "hau" "heb" "hin" "hun" "isl" "ibo" "ind" "ita" "jpn" "jav" "kan" "kaz" "khm" "kor" "kur" "kir" "lao" "lav" "lit" "ltz" "mkd" "mlg" "msa" "mal" "mlt" "mar" "ell" "mon" "npi" "pus" "fas" "pol" "por" "pan" "ron" "rus" "srp" "sna" "snd" "sin" "slk" "slv" "som" "spa" "sun" "swh" "swe" "tgl" "tam" "tel" "tha" "tur" "ukr" "urd" "uzb" "vie" "cym" "xho" "yor" "zul" "bel")
JW300_LANGS_COMMON3=("nya" "af" "am" "ar" "hy" "az" "bn" "" "bg" "my" "cat" "ceb" "" "hr" "cs" "da" "nl" "en" "et" "fi" "fr" "gl" "ka" "de" "gu" "ha" "he" "hi" "hu" "is" "ig" "id" "it" "ja" "jv" "kn" "kk_Cyrl" "km" "ko" "" "ky" "lo" "lv" "lt" "" "mk" "mg" "zlm" "ml" "mt" "mr" "el" "mn" "ne" "" "fa" "pl" "pt" "pa" "ro" "ru" "sr_Cyrl" "sn" "" "si" "sk" "sl" "" "es" "su" "sw" "sv" "tl" "ta" "te" "th" "tr" "uk" "ur" "uz_Latn" "vi" "cy" "xh" "yo" "zu" "")
FLORES_101_LANGS_COMMON3=("ny" "af" "am" "ar" "hy" "az" "bn" "bs" "bg" "my" "ca" "cx" "zh" "hr" "cs" "da" "nl" "en" "et" "fi" "fr" "gl" "ka" "de" "gu" "ha" "he" "hi" "hu" "is" "ig" "id" "it" "ja" "jv" "kn" "kk" "km" "ko" "ku" "ky" "lo" "lv" "lt" "lb" "mk" "mg" "ms" "ml" "mt" "mr" "el" "mn" "ne" "ps" "fa" "pl" "pt" "pa" "ro" "ru" "sr" "sn" "sd" "si" "sk" "sl" "so" "es" "su" "sw" "sv" "tl" "ta" "te" "th" "tr" "uk" "ur" "uz" "vi" "cy" "xh" "yo" "zu" "be")
LID_187_LANGS_COMMON3=("" "af" "am" "ar" "hy" "az" "bn" "bs" "bg" "my" "ca" "ceb" "zh" "hr" "cs" "da" "nl" "en" "et" "fi" "fr" "gl" "ka" "de" "gu" "ha" "he" "hi" "hu" "is" "ig" "id" "it" "ja" "jv" "kn" "kk" "km" "ko" "ku" "ky" "lo" "lv" "lt" "lb" "mk" "mg" "ms" "ml" "mt" "mr" "el" "mn" "ne" "ps" "fa" "pl" "pt" "pa" "ro" "ru" "sr" "sn" "sd" "si" "sk" "sl" "so" "es" "su" "sw" "sv" "tl" "ta" "te" "th" "tr" "uk" "ur" "uz" "vi" "cy" "xh" "yo" "zu" "be")
CLD3_LANGS_COMMON3=("ny" "af" "am" "ar" "hy" "az" "bn" "bs" "bg" "my" "ca" "ceb" "zh" "hr" "cs" "da" "nl" "en" "et" "fi" "fr" "gl" "ka" "de" "gu" "ha" "iw" "hi" "hu" "is" "ig" "id" "it" "ja" "jv" "kn" "kk" "km" "ko" "ku" "ky" "lo" "lv" "lt" "lb" "mk" "mg" "ms" "ml" "mt" "mr" "el" "mn" "ne" "ps" "fa" "pl" "pt" "pa" "ro" "ru" "sr" "sn" "sd" "si" "sk" "sl" "so" "es" "su" "sw" "sv" "fil" "ta" "te" "th" "tr" "uk" "ur" "uz" "vi" "cy" "xh" "yo" "zu" "be")
...
prepare_flores_dev_data () {
    ...
    for i in "${!ISO_639_3_LANGS_COMMON3[@]}"; do
        ISO_639_3_LANG=${ISO_639_3_LANGS_COMMON3[i]}
        FLORES_101_LANG=${FLORES_101_LANGS_COMMON3[i]}
...
eval_dev_cld3 () {
    PREDICTIONS="$RESULT_FOLDER/flores-dev.cld3.predictions"
    GOLD="$RESULT_FOLDER/flores-dev.gold"
    ...
    RESULT_TXT="$RESULT_FOLDER/result.classifiermetrics-flores-dev.cld3.txt"
    CLASSIFIER_METRICS="/private/home/celebio/nlp/nllb_lid/misc/classifier_metrics.py"
    $CLASSIFIER_METRICS --prediction $PREDICTIONS --gold $GOLD > $RESULT_TXT
