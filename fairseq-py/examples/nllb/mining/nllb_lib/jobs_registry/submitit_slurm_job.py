...
# The job registry however displays only 6 high-level essential statuses. This can be seen in the RegistryStatuses Enum in examples/nllb/mining/nllb_lib/jobs_registry/nllb_job.py
...
class SubmititJob(NLLBJob):
    ...
    def __init__(
        ...
        # Calling parent class (NLLBJob) constructor
        super().__init__(
            job_id=job_id,
