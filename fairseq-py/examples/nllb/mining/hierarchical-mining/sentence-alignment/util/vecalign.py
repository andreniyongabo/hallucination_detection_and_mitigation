...
def add_debug_args(parser):
    parser.add_argument('-a', '--alignment_max_size', type=int, default=6,
                        help='Searches for alignments up to size N-M, where N+M <= this value. Note: overlaps required TODO TODO')
