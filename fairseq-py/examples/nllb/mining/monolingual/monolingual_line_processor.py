...
from examples.nllb.mining.monolingual.utils import slurm_tmp_maybe
...
from examples.nllb.mining.monolingual.utils.remove_non_printing_char import (
    get_replacer as non_printing_char_replacer,
)
from examples.nllb.mining.monolingual.utils.remove_regex import (
    get_ascii_hashtag_replacer as hashtag_replacer,
)
from examples.nllb.mining.monolingual.utils.remove_regex import (
    get_url_replacer as url_replacer,
)
from examples.nllb.mining.monolingual.utils.sentence_split import get_split_algo
from examples.nllb.mining.monolingual.utils.sort import build_sort_command
from examples.nllb.mining.monolingual.utils.text_filter import keep_it
...
class LIDConfig:
    ...
    latest_models_path: str = "/private/home/celebio/lid_latest_models/"
