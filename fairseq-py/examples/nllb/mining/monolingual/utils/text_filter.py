...
def test_keep_it():
    def keep_it_test_func(string, min_chars=1, max_chars=200, max_punct_ratio=1, 
                          max_number_ratio=1, min_space_ratio=0, max_space_ratio=1, 
                          max_emoji_ratio=1, max_repeated_char=10):
        return keep_it(
            string, min_chars=min_chars, max_chars=max_chars, max_punct_ratio=max_punct_ratio, 
            max_number_ratio=max_number_ratio, min_space_ratio=min_space_ratio, 
            max_space_ratio=max_space_ratio, max_emoji_ratio=max_emoji_ratio, max_repeated_char=max_repeated_char)
