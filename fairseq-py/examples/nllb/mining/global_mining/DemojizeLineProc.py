...
from examples.nllb.mining.global_mining.utils.demojizer import Demojizer
...
class DemojizeLineProc(MultiprocLineProcessorCallback):
    """
    this is a cb for cleaning emojis line by line in paralell with MultiprocLineProcessor.
    ...
    def merge_results(self, splits: tp.List[Path]) -> Path:
        ...
        # TODO replace lzma for utils.open when we figure out the binary mode
            ...
            line_processor=DictConfig(
                {
                    ...
                    "_target_": "examples.nllb.mining.global_mining.DemojizeLineProc.DemojizeLineProc",
