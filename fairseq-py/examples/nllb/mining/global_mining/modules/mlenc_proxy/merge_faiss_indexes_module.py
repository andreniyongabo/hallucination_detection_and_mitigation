...
from examples.nllb.mining.global_mining.mining_utils import get_cached_line_count
...
logger = logging.getLogger("merge_faiss_indexes")
...
class MergeFAISSIndexesModule(NLLBModule):
    def __init__(
        self,
