...
class LineProcessorCallback(AbstractContextManager):
    ...
    def __init__(
        self, outfile_prefix: str, input_file: str, input_file_idx: int, output_dir: str
    ) -> None:
...
class LineProcessorModule(NLLBModule):
    def __init__(
    ...
    def run(
        ...
        with nllb_lib.utils.open(input_file) as filep:
