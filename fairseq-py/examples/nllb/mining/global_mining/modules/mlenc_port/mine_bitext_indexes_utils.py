...
def mine(
    ...
    # extracting bitexts
    # TODO: add dedup logic if we need it again
...
def load_neighbors(
    ...
    # loading all indices
    # TODO: the logic below is weird. Dimensions of dists and indices are out of sync
    # on disk. This is due to the saving logic in calculate_distances
