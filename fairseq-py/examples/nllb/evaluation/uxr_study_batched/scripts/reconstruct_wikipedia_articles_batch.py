...
def main():
    ...
    for lang in LANGUAGES:
        ...
        # print("check translations file length (should be 122):",len(translations))
        if len(translations) != 122:
            print(f"{lang} translation file incomplete {len(translations)}/122, skipping")
            continue
        else:
