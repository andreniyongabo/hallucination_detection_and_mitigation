#CHECKPOINT_DIR=/checkpoint/chau/noising_augmentation/noising/noising.fp16.uf4.entsrc.tmp5.shem.ilr1e-07.wu4000.lr0.001.clip0.0.drop0.1.wd0.0.seed2.no_c10d.det.mt4000.m0.3.mr0.1.i0.0.p0.0.r0.0.pl3.5.mlspan-poisson.rl1.transformer.ELS12.encffnx4096.E1024.H16.NBF.ATTDRP0.1.RELDRP0.0.ngpu32
...
input_file=/private/home/chau/wmt21/all_eval_sets/en-ha/flores_test.en-ha.en
ref_file=/private/home/chau/wmt21/all_eval_sets/en-ha/flores_test.en-ha.ha
src=eng
tgt=hau
langs="eng,hau,ibo"
...
sacrebleu ${ref_file} -l en-ha < ${prefix}.hyp > ${prefix}.results
