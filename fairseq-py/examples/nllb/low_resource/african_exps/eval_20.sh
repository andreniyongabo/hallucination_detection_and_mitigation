for model_prefix in african20.x_en.64k/checkpoints/african20.x_en.64k.uf4.lr0.001.drp0.1.ls0.1.seed1234.els12.dls12.adrp0.1.rdrp0.0.ngpu64 african20.x_en.64k/checkpoints/african20.x_en.64k.uf4.lr0.001.drp0.2.ls0.1.seed1234.els12.dls12.adrp0.1.rdrp0.0.ngpu64; do
  for src in amh ful dyu hau ibo kam kmb kon lin lug luo nso nya orm sna som ssw swh tir tsn umb wol xho yor zul; do
    ...
    DATADIR=/large_experiments/mmt/multilingual_bin/flores_african_en_20langs.64k
