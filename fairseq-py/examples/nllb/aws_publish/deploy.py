...
def main(folder: Path, docker: str = "", prod: bool = False):
    ...
    You'll also need temporary AWS credentials.
    From a devvm run `awsume api 022599147766 SSOAdmin`.
    This requires `feature install cloud cloudsec_awsume`
...
From a devvm run `awsume api 022599147766 SSOAdmin` and copy credentials here.
This requires `feature install cloud cloudsec_awsume`.
"""
        )
