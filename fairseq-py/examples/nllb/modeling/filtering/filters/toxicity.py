...
from examples.nllb.mining.monolingual.utils.text_normalizer import replace_unicode_punct
...
class ToxicityList:
    ...
    def _tokenize(self, s: str):
        ...
        # example: `" xyz " in " abc wxyz "` is False
        return " " + tok + " "
...
class ToxicityFilter(Filter):
    def __init__(
        ...
        # load English porn list regardless of actual lang
