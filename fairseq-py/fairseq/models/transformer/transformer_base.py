...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--decoder-learned-sinusoidal', action='store_true',
                            help='use learned positional embeddings in the decoder but init with sinusoidal')
        ...
        parser.add_argument('--pass-tokens-transformer-layer', default=False, action='store_true',
        ...
        # embedding dropout toggle
        parser.add_argument('--no-emb-dropout', default=False, action='store_true', help='Avoids dropout on embeddings')
        parser.add_argument('--init-model-on-gpu', default=False, action='store_true', help='Avoids dropout on embeddings')
        # fmt: on
...
def base_architecture(args):
    ...
    args.no_emb_dropout = getattr(args, "no_emb_dropout", False)
