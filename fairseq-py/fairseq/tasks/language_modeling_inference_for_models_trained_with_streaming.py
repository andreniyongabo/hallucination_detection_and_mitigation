...
@dataclass
class LanguageModelingInferenceForModelsTrainedWithStreamingConfig(FairseqDataclass):
...
class LanguageModelingInferenceForModelsTrainedWithStreamingTask(LegacyFairseqTask):
    """
    ...
    def __init__(self, args, tokenizer, targets=None):
        ...
        for id in range(self.dictionary.nspecial, self.tokenizer.get_vocab_size()):
            # This aims at producing a dict with first symbols being special (<s> <pad>)
            # and the rest '4', '5' to be backward compatible with the current few_shot eval logic. See examples/few_shot/predictor.py
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, **kwargs):
        ...
        src_dataset = PrependTokenDataset(
            ...
            token=(
                ...
                else self.eod  # In some models we accidently replaced this with <endoftext/> (id:4)
