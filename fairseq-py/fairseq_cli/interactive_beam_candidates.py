...
def main(cfg: FairseqConfig):
    ...
    ########################
    # vairiables to hold all candidates with their source sentences
    output_dict = {}
    source_sents = []
    target_sents = []
    scores = []
    ...
    for inputs in buffered_read(cfg.interactive.input, cfg.interactive.buffer_size):
        ...
        ########################################
        # variables to hold candidates of each input sentence
        output_temp_dict = {}
        src_sents = []
        tgt_sents = []
        sent_scores = []
        ...
        for id_, src_tokens, hypos, info in sorted(results, key=lambda x: x[0]):
            ...
            ##########################################
            # save current candidate information into a temporaly dictionary
            output_temp_dict = {"source":src_sents, "target":tgt_sents, "sent_score":sent_scores}
            ##########################################

        ############################################
        # save all candidates information of each source sentence into a dictionary
        output_dict[start_id] = output_temp_dict
        ############################################
