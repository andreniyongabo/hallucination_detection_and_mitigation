...
class S3PathHandler(PathHandler):
    ...
    def _get_client(self, bucket: str):
        # TODO: Consider pid-based cache: https://www.internalfb.com/intern/diffusion/FBS/browsefile/master/fbcode/fair_infra/data/iopath/iopath/fb/manifold.py?commit=abfe1f86ed3ae9796a17c031c6cdfd94907a173d&lines=790
