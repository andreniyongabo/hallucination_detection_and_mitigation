...
class RobertaModelConfig(FairseqDataclass):
    ...
    pooler_activation_fn: ChoiceEnum(utils.get_available_activation_fns()) = field(
        default="tanh",
        metadata={"help": "activation function to use for the pooler layer"},
    )
    ...
    max_source_positions: int = field(
        default=512,
        metadata={"help": "number of source positional embeddings to learn"},
    )
    ...
    spectral_norm_classification_head: bool = field(
        default=False,
        metadata={"help": "Apply spectral normalization on the classification head"},
    )
    ...
    scale_fc: Optional[bool] = field(
        default=False, metadata={"help": "Layernorm between fc"}
    )
    scale_attn: Optional[bool] = field(
        default=False, metadata={"help": "Layernorm after attn"}
    )
    scale_heads: Optional[bool] = field(
        default=False, metadata={"help": "Early-bert attention head pruning coeff"}
    )
