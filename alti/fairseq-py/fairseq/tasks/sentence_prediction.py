...
class SentencePredictionConfig(FairseqDataclass):
    ...
    shorten_method: Optional[
        ChoiceEnum(["none", "truncate", "random_crop"])  # noqa: F821
    ] = field(
        default="none",
        metadata={
    ...
    max_positions: Optional[int] = II("model.max_positions")
    max_source_positions: Optional[int] = II("model.max_source_positions")
