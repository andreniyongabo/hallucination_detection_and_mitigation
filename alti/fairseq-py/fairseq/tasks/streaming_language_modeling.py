...
@dataclass
class StreamingLanguageModelingConfig(FairseqDataclass):
...
class StreamingLanguageModelingTask(LegacyFairseqTask):
    """
    ...
    def __init__(self, args):
        ...
        final_vocab_size = getattr(args, "final_vocab_size", None)
    ...
    def has_sharded_data(self, split):
        # always return True so that load_dataset is called
        return True
