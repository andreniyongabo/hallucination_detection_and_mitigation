...
def get_grid(args):
    # max_update = 28000 # 64e_32gpus
    max_update = 24000  # 128e_64gpus TODO: change
    save_updates = 2000  # TODO: change
    args.data = SHARDED_ENGLISH_DATA
    args.snapshot_code = False if args.local else True
    experts_per_gpu = getattr(args, "local_experts", 1)
    uf = 512 / (args.num_nodes * args.num_gpus)  # TODO: change
    # uf = 256 / (args.num_nodes * args.num_gpus)
    return [
