...
def get_transformer_12_12_8k_02_grid():
    return [
        ...
        hyperparam("--decoder-normalize-before", True, binary_flag=True),
        hyperparam("--attention-dropout", 0.2, save_dir_key=lambda val: f"ATTDRP{val}"),
        hyperparam("--relu-dropout", 0.2, save_dir_key=lambda val: f"RELDRP{val}"),
    ]
...
def get_transformer_12_12_8k_03_grid():
    return [
        ...
        hyperparam("--decoder-normalize-before", True, binary_flag=True),
        hyperparam("--attention-dropout", 0.3, save_dir_key=lambda val: f"ATTDRP{val}"),
        hyperparam("--relu-dropout", 0.3, save_dir_key=lambda val: f"RELDRP{val}"),
    ]
...
def get_grid(args):
    ...
    grids = [
        ...
        hyperparam("--label-smoothing", args.label_smoothing),
