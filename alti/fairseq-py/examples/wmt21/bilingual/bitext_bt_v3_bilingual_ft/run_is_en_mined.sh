...
for seed in 1; do
  for arch in "transformer_12_12_8k"; do
    for lr in 0.0001; do
      python examples/wmt21/bilingual/sweep_1n.py \
          ...
          --finetune-from-model /checkpoint/chau/wmt21/bitext_bt_v3_bilingual/is_en.bitext_bt.v3/dense.mfp16.fp16.uf4.entsrc.SPL_temperature.tmp5.shem.ilr1e-07.wu4000.lr0.001.clip0.0.drop0.2.wd0.0.seed1.c10d.det.mt6000.transformer.ELS12.DLS12.encffnx8192.decffnx8192.E1024.H16.NBF.ATTDRP0.2.RELDRP0.2.ngpu32/checkpoint_best.pt  \
          --snapshot-code
    done
  done
done
