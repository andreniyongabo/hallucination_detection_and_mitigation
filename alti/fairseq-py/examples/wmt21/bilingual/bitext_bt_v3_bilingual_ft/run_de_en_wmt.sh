  ...
  for arch in "transformer_12_12_no_share"; do
    for lr in 0.0001; do
      python examples/wmt21/bilingual/sweep_1n.py \
          ...
          --finetune-from-model /checkpoint/chau/wmt21/bitext_bt_v3_bilingual/wmt_only_rev.bitext_bt.v3.64_shards.transformer_12_12.fp16.SPL_temperature.tmp5.adam.lr0.001.drop0.1.ls0.1.seed1.c10d.det.transformer.ELS12.DLS12.encffnx4096.decffnx4096.E1024.H16.NBF.ATTDRP0.1.RELDRP0.0.ngpu32.de_en/checkpoint_best.pt \
          --snapshot-code
    done
  done
done
