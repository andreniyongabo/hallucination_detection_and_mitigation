...
LANGS = ["afr","amh","ara","asm","ast","azj","bel","ben","bos","bul","cat","ceb","ces","cym","dan","deu","ell","est","fas","fin","fra","ful","gle","glg","guj","hau","heb","hin","hrv","hun","hye","ibo","ind","isl","ita","jav","jpn","kam","kan","kat","kaz","kea","khm","kir","kor","kur","lao","lav","lin","lit","ltz","lug","luo","mal","mar","mkd","mlt","mon","mri","msa","mya","nld","nob","npi","nso","nya","oci","orm","ory","pan","pol","por","pus","ron","rus","slk","slv","sna","snd","som","spa","srp","swe","swh","tam","tel","tgk","tgl","tha","tur","ukr","umb","urd","vie","wol","xho","yor","zho","zul"]
...
def get_bleus(type="valid"):
    ...
    for lang in LANGS:
        ...
        bleus[lang] = {}
        try:
            fname = list(glob.glob(os.path.join(MODEL_DIR, f"{src}-{tgt}_checkpoint_last_{type}", "bleu.results")))[0]
