...
EXPERIMENT_NAME="2021-12-21-14-08-semisuper"
...
train_fasttext_8_2 () {
    ...
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.2 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 2 -dim 256 -loss hs -bucket 1000000 -thread 60
}

train_fasttext_8_3 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.3 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 100 -epoch 2 -dim 256 -loss hs -bucket 1000000 -thread 60
}

train_fasttext_8_4 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.4 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 1 -dim 256 -loss hs -bucket 1000000 -thread 60
}

train_fasttext_8_5 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.5 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 5 -dim 256 -loss hs -bucket 1000000 -thread 60
}

train_fasttext_8_6 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.6 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 2 -dim 512 -loss hs -bucket 1000000 -thread 60
}

train_fasttext_8_7 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.7 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 10 -dim 300 -loss hs -bucket 5000000 -thread 60
}
...
train_fasttext_8_9 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.samelimit.txt -output $RESULT_FOLDER/model.8.9 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 2 -dim 256 -loss hs -bucket 1000000 -thread 60
}
...
train_fasttext_8_10 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.10 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 5 -dim 300 -loss hs -bucket 5000000 -thread 60
}

train_fasttext_8_11 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.11 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 10 -epoch 10 -dim 300 -loss hs -bucket 5000000 -thread 60
}

train_fasttext_8_12 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.12 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 5 -dim 300 -loss hs -bucket 5000000 -thread 60
}

train_fasttext_8_13 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.13 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 10 -dim 300 -loss hs -bucket 5000000 -thread 60
}

train_fasttext_8_14 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.14 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 10 -dim 300 -loss softmax -bucket 5000000 -thread 60
}

train_fasttext_8_15 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.upsampl.txt -output $RESULT_FOLDER/model.8.15 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 15 -dim 300 -loss softmax -bucket 5000000 -thread 60
}
...
# B
    # $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.8.1 \
    #     -lr 0.8 -minn 2 -maxn 5 -minCount 1 -epoch 5 -dim 512 -loss hs -bucket 2000000 -thread 60
