...
EXPERIMENT_NAME="2021-09-20-23-26-goal124-filter-percentile"
...
prepare_data_3_combine() {
    ...
    for i in "${!GOAL124__ISO_639_3_LANGS[@]}"; do
        ...
        MONO_CAT_FILE="$TRAIN_DIR/$ISO_639_3_LANG.cleaned.$THRESH_SCORE.txt"
...
train_fasttext_5 () {
    ...
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.5 \
        -lr 0.5 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 128 -loss ova -bucket 10000000 -thread 40
}

train_fasttext_6 () {
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $RESULT_FOLDER/model.6 \
        -lr 0.5 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 256 -loss ova -bucket 10000000 -thread 40
}

train_fasttext_6_1 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.6.1 \
        -lr 0.1 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_6_2 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.6.2 \
        -lr 0.2 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_6_3 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.6.3 \
        -lr 0.3 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_6_8 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.6.8 \
        -lr 0.8 -minn 2 -maxn 5 -minCount 1000 -epoch 1 -dim 256 -loss ova -bucket 10000000 -thread 40
}
...
train_fasttext_8_1 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.8.1 \
        -lr 0.1 -minn 2 -maxn 5 -minCount 1000 -epoch 2 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_8_2 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.8.2 \
        -lr 0.2 -minn 2 -maxn 5 -minCount 1000 -epoch 2 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_8_3 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.8.3 \
        -lr 0.3 -minn 2 -maxn 5 -minCount 1000 -epoch 2 -dim 256 -loss ova -bucket 10000000 -thread 40
}
train_fasttext_8_8 () {
    TEMP_RESULT_FOLDER="/checkpoint/celebio/projects/nlp/lidruns/2021-09-20-23-26-goal124-filter-percentile/result"
    echo "Training fastText:"
    $FASTTEXT_BIN supervised -input $TRAIN_DIR/all.txt -output $TEMP_RESULT_FOLDER/model.8.8 \
...
eval_flores_filled_fasttext_variants_6 () {
    # TEMP_RESULT_FOLDER
    GOLD="$TEMP_RESULT_FOLDER/flores-filled.gold"
    TEST_FILE="$TEST_DIR/flores-filled.txt"
    cat "$TEST_FILE" | cut -f 1 -d" " > $GOLD
    ...
    for i in `seq 1 9`
    do
        RESULT_TXT="$TEMP_RESULT_FOLDER/result.classifiermetrics-flores-filled.fasttext.6.$i.txt"

        LID_MODEL="$TEMP_RESULT_FOLDER/model.6.$i.bin"

        if [ -s $LID_MODEL ]
        then
            echo "LID_MODEL $LID_MODEL"
            PREDICTIONS="$TEMP_RESULT_FOLDER/flores-filled.fasttext.predictions.6.$i"
...
eval_flores_filled_fasttext_variants_8 () {
    ...
    for i in `seq 1 9`
    do
        RESULT_TXT="$TEMP_RESULT_FOLDER/result.classifiermetrics-flores-filled.fasttext.8.$i.txt"

        LID_MODEL="$TEMP_RESULT_FOLDER/model.8.$i.bin"

        if [ -s $LID_MODEL ]
        then
            echo "LID_MODEL $LID_MODEL"
            PREDICTIONS="$TEMP_RESULT_FOLDER/flores-filled.fasttext.predictions.8.$i"
