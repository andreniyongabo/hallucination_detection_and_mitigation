...
if data_sample=='generate':
    with open(r"./data/devtestdyu."+source, 'r') as fp:
        for i, line in enumerate(fp):    
            src_sent, src_tok, src_tensor, tgt_sent, tgt_tok, tgt_tensor = hub.get_sample('devtestdyu', i)
...
#print (str(df_src_contribution.src_contribution[i])) #here the info
#            __eng__        0.339077
#▁Hum           0.892592
#▁began         0.815760
#▁to            0.754281
